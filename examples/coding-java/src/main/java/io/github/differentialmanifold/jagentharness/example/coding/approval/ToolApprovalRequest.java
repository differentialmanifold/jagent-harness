...
public class ToolApprovalRequest {
    ...
    public ToolApprovalRequest(String title, String message, String action, String target) {
        this(
                "appr_" + java.util.UUID.randomUUID(),
                null,
                null,
                title,
                message,
    ...
    public ToolApprovalRequest(
        ...
        this.approvalId = isBlank(approvalId) ? "appr_" + java.util.UUID.randomUUID() : approvalId;
    ...
    public ToolApprovalRequest withCodingContext(String currentToolCallId, String currentToolName) {
