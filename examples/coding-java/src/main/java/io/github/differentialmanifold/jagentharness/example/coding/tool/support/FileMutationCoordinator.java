...
public final class FileMutationCoordinator {
    ...
    public static LockHandle acquire(Path path) throws IOException, InterruptedException {
        ...
        throw new IOException(
                "Path kept changing while acquiring its mutation lock: " + lastResolvedPath);
    }
    ...
    public static boolean writeAtomicallyIfUnchanged(Path target, byte[] expected, byte[] bytes)
            throws IOException {
        ...
        try {
            DosFileAttributeView dosView =
                    Files.getFileAttributeView(
                            temporary, DosFileAttributeView.class, LinkOption.NOFOLLOW_LINKS);
            if (dosView != null) {
                try {
    ...
    private static void moveReplacingWithRetry(Path source, Path target, boolean atomic)
            throws IOException {
    ...
    public static final class FileBusyException extends IOException {
        ...
        private FileBusyException(Path target, IOException cause) {
            super(
                    "File could not be replaced after short retries; it may be open or access may be denied: "
                            + target,
                    cause);
            this.target = target;
        }
    ...
    public static final class HardLinkException extends IOException {
        ...
        private HardLinkException(Path target, long linkCount) {
            super(
                    "Atomic replacement would detach this path from its "
                            + linkCount
                            + " hard links: "
                            + target);
            this.target = target;
    ...
    public static final class PathChangedException extends IOException {
        ...
        private PathChangedException(Path approvedTarget, Path currentTarget) {
            super(
                    "The target path resolved to a different location while the file operation was running: "
                            + currentTarget);
    ...
    private static final class FileMetadata {
        ...
        private static FileMetadata capture(Path source) throws IOException {
            ...
            FileOwnerAttributeView ownerView =
                    Files.getFileAttributeView(source, FileOwnerAttributeView.class, noFollow);
            if (ownerView != null) {
                try {
            ...
            try {
                PosixFileAttributes attributes =
                        Files.readAttributes(source, PosixFileAttributes.class, noFollow);
                metadata.group = attributes.group();
                metadata.posixPermissions =
                        new HashSet<PosixFilePermission>(attributes.permissions());
            } catch (UnsupportedOperationException ignored) {
                // Windows and other non-POSIX providers use ACL/DOS views instead.
            }

            AclFileAttributeView aclView =
                    Files.getFileAttributeView(source, AclFileAttributeView.class, noFollow);
            if (aclView != null) {
                try {
            ...
            try {
                DosFileAttributes attributes =
                        Files.readAttributes(source, DosFileAttributes.class, noFollow);
            ...
            UserDefinedFileAttributeView userView =
                    Files.getFileAttributeView(
                            source, UserDefinedFileAttributeView.class, noFollow);
            if (userView != null) {
                try {
        ...
        private void applyTo(Path target) throws IOException {
            ...
            if (owner != null) {
                FileOwnerAttributeView ownerView =
                        Files.getFileAttributeView(target, FileOwnerAttributeView.class, noFollow);
                if (ownerView == null) {
            ...
            if (group != null || posixPermissions != null) {
                PosixFileAttributeView posixView =
                        Files.getFileAttributeView(target, PosixFileAttributeView.class, noFollow);
                if (posixView == null) {
            ...
            if (acl != null) {
                AclFileAttributeView aclView =
                        Files.getFileAttributeView(target, AclFileAttributeView.class, noFollow);
                if (aclView == null) {
            ...
            if (userAttributes != null) {
                UserDefinedFileAttributeView userView =
                        Files.getFileAttributeView(
                                target, UserDefinedFileAttributeView.class, noFollow);
                if (userView == null) {
            ...
            if (dosArchive != null) {
                DosFileAttributeView dosView =
                        Files.getFileAttributeView(target, DosFileAttributeView.class, noFollow);
                if (dosView == null) {
        ...
        private static boolean userAttributesEqual(
                Map<String, byte[]> left, Map<String, byte[]> right) {
            if (left == right) {
                return true;
            }
        ...
        private static void writeUserAttributes(
                UserDefinedFileAttributeView view, Map<String, byte[]> attributes)
                throws IOException {
            ...
            for (Map.Entry<String, byte[]> attribute : attributes.entrySet()) {
                ...
                if (written != attribute.getValue().length) {
                    throw new IOException(
                            "Could not preserve complete extended attribute: "
                                    + attribute.getKey());
                }
            }
        }
